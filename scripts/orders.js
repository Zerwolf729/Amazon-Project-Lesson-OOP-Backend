  ...
  .forEach((button) => {
    button.addEventListener(
      'click', () => {
        ...
        /*
        const quantityElement = button.closest('.product-details').querySelector('.product-quantity');
...
console.log('Order HTML container count:', document.querySelectorAll('.order-container').length);
